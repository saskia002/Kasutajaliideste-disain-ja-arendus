...
export default function Bottom() {
    return <div id="mp-bottom" class="mp-box">
        <h2 id="mp-other" class="mp-h2">
            <span id="Other_areas_of_Wikipedia" class="mw-headline">Other areas of Wikipedia</span>
        </h2>
        <div id="mp-other-content">
            <ul>
                ...
                <li><b><a href="" title="Wikipedia:Contents/Portals">Content portals</a></b> – A unique way to navigate the encyclopedia.</li>
            </ul>
        </div>
        ...
        <div id="mp-sister-content">
            <p>Wikipedia is written by volunteer editors and hosted by the 
                ...
                <a href="https://wikimediafoundation.org/our-work/wikimedia-projects/" class="extiw" title="foundationsite:our-work/wikimedia-projects/"> projects</a>:
            </p>
            <div class="plainlist">
                    ...
                    <li>
                        <div>
                            <a href="https://commons.wikimedia.org/wiki/" title="Commons">
                                <img alt="Commons logo" src="//upload.wikimedia.org/wikipedia/en/thumb/4/4a/Commons-logo.svg/31px-Commons-logo.svg.png" decoding="async" 
                                ...
                                data-file-width="1024" data-file-height="1376" width="31" height="42" />
                            </a>
                        </div>
                    ...
                    <li>
                        <div>
                            <a href="https://www.mediawiki.org/wiki/" title="MediaWiki">
                                <img alt="MediaWiki logo" src="//upload.wikimedia.org/wikipedia/commons/thumb/a/a6/MediaWiki-2020-icon.svg/35px-MediaWiki-2020-icon.svg.png" decoding="async" 
                                ...
                                data-file-width="100" data-file-height="100" width="35" height="35" />
                            </a>
                        </div>
                    ...
                    <li>
                        <div>
                            <a href="https://meta.wikimedia.org/wiki/" title="Meta-Wiki">
                                <img alt="Meta-Wiki logo" src="//upload.wikimedia.org/wikipedia/commons/thumb/7/75/Wikimedia_Community_Logo.svg/35px-Wikimedia_Community_Logo.svg.png" decoding="async" 
                                ...
                                data-file-width="900" data-file-height="900" width="35" height="35" />
                            </a>
                        </div>
                    ...
                    <li>
                        <div>
                            <a href="https://en.wikibooks.org/wiki/" title="Wikibooks">
                                <img alt="Wikibooks logo" src="//upload.wikimedia.org/wikipedia/commons/thumb/f/fa/Wikibooks-logo.svg/35px-Wikibooks-logo.svg.png" decoding="async" 
                                ...
                                data-file-width="300" data-file-height="300" width="35" height="35" />
                            </a>
                        </div>
                    ...
                    <li>
                        <div>
                            <a href="https://en.wikiquote.org/wiki/" title="Wikiquote">
                                <img alt="Wikiquote logo" src="//upload.wikimedia.org/wikipedia/commons/thumb/f/fa/Wikiquote-logo.svg/35px-Wikiquote-logo.svg.png" decoding="async" 
                                ...
                                data-file-width="300" data-file-height="355" width="35" height="41" />
                            </a>
                        </div>
                    ...
                    <li>
                        <div>
                            <a href="https://en.wikisource.org/wiki/" title="Wikisource">
                                <img alt="Wikisource logo" src="//upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Wikisource-logo.svg/35px-Wikisource-logo.svg.png" decoding="async" 
                                ...
                                data-file-width="410" data-file-height="430" width="35" height="37" />
                            </a>
                        </div>
                    ...
                    <li>
                        <div>
                            <a href="https://species.wikimedia.org/wiki/" title="Wikispecies">
                                <img alt="Wikispecies logo" src="//upload.wikimedia.org/wikipedia/commons/thumb/d/df/Wikispecies-logo.svg/35px-Wikispecies-logo.svg.png" decoding="async" 
                                ...
                                data-file-width="941" data-file-height="1103" width="35" height="41" />
                            </a>
                        </div>
                    ...
                    <li>
                        <div>
                            <a href="https://en.wikiversity.org/wiki/" title="Wikiversity">
                                <img alt="Wikiversity logo" src="//upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Wikiversity_logo_2017.svg/41px-Wikiversity_logo_2017.svg.png" decoding="async" 
                                ...
                                data-file-width="626" data-file-height="512" width="41" height="34" />
                            </a>
                        </div>
                    ...
                    <li>
                        <div>
                            <a href="https://en.wikivoyage.org/wiki/" title="Wikivoyage">
                                <img alt="Wikivoyage logo" src="//upload.wikimedia.org/wikipedia/commons/thumb/d/dd/Wikivoyage-Logo-v3-icon.svg/35px-Wikivoyage-Logo-v3-icon.svg.png" decoding="async" 
                                ...
                                data-file-width="193" data-file-height="193" width="35" height="35" />
                            </a>
                        </div>
                    ...
                    <li>
                        <div>
                            <a href="https://en.wiktionary.org/wiki/" title="Wiktionary">
                                <img alt="Wiktionary logo" src="//upload.wikimedia.org/wikipedia/en/thumb/0/06/Wiktionary-logo-v2.svg/35px-Wiktionary-logo-v2.svg.png" decoding="async" 
                                ...
                                data-file-width="391" data-file-height="391" width="35" height="35" />
                            </a>
                        </div>
        ...
        <div>
            <div class="wikipedia-languages nourlexpansion">
                <p>This Wikipedia is written in 
                    <a href="" title="English language"> English</a>. 
                    Many <a href="https://meta.wikimedia.org/wiki/List_of_Wikipedias" class="extiw" title="meta:List of Wikipedias"> other Wikipedias are available</a>;
